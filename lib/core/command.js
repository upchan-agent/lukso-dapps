 ...
 *
 *     return {
 *       payload: buildExecutePayload(CONTRACTS.LSP26, data),
 *       meta: { target }
 *     };
 *   }
 *
...
export class DappCommand {
   ...
   *                               LUKSO: UP.execute() encoded via buildExecutePayload
 ...
 */
export function buildExecutePayload(target, data, value = 0, operation = 0) {
