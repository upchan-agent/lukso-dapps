...
export const CONTRACTS = {
  ...
  // ERC-8004 Registries (LUKSO mainnet)
...
export const ABIS = {
  ...
  LSP26: [
    ...
    'function getFollowsByIndex(address addr, uint256 startIndex, uint256 endIndex) view returns (address[] memory)',
    'function getFollowersByIndex(address addr, uint256 startIndex, uint256 endIndex) view returns (address[] memory)',
  ],
